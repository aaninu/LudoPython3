...
class Ludo:
    ...
    def player(self, color):
        if (color == "GREEN"):
            return pygame.image.load("img/pion_green" +str(self.pionsColor[0])+ ".png")
        elif (color == "RED"):
            return pygame.image.load("img/pion_red" +str(self.pionsColor[1])+ ".png")
        elif (color == "BLUE"):
            return pygame.image.load("img/pion_blue" +str(self.pionsColor[2])+ ".png")
        else:
            return pygame.image.load("img/pion_yellow" +str(self.pionsColor[3])+ ".png")
